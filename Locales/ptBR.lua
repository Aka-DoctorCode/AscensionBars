...
Locales["ENABLE_DESC"] = "Ativa ou desativa esta barra de progresso específica."
...
Locales["PER_BLOCK_OFFSET_DESC"] = "Ativa para definir deslocamentos Y independentes para os blocos superior e inferior, em vez de um único deslocamento global."
Locales["PER_BLOCK_GAP"] = "Usar espaçamento por bloco"
Locales["PER_BLOCK_GAP_DESC"] = "Ativa para definir espaçamentos independentes para os blocos superior e inferior."
...
Locales["USE_PER_BLOCK_HEIGHT_DESC"] = "Ativa para definir alturas de barra diferentes para os blocos superior e inferior."
Locales["USE_CUSTOM_HEIGHT"] = "Altura personalizada"
Locales["USE_CUSTOM_HEIGHT_DESC"] = "Alterna entre usar a altura global do bloco ou definir uma altura única para esta barra específica."
...
Locales["USE_CUSTOM_FACTION_COLORS"] = "Usar cores de facção personalizadas"
Locales["USE_CUSTOM_FACTION_COLORS_DESC"] = "Aplica cores exclusivas com temática oficial a facções específicas nas barras de reputação ativas."
Locales["CUSTOM_FACTION_COLORS"] = "Cores de facção personalizadas"
Locales["ACTIVE_FACTION_COLORS"] = "Cores de facções ativas"
...
Locales["BARS_HIDDEN_COMBAT_HOVER"] = "Barras ocultas - Passe o mouse para exibir (Ocultas em combate)"
Locales["BARS_HIDDEN_HOVER"] = "Barras ocultas - Passe o mouse para exibir"
Locales["BARS_HIDDEN_COMBAT"] = "Barras ocultas em combate"
Locales["SHOW_ON_MOUSEOVER"] = "Mostrar ao passar o mouse"
Locales["SHOW_ON_MOUSEOVER_DESC"] = "Mostra as barras apenas quando o mouse está sobre elas. Se desativado, as barras estarão sempre visíveis, a menos que a ocultação em combate esteja ativa."
Locales["HIDE_IN_COMBAT"] = "Ocultar em combate"
Locales["HIDE_IN_COMBAT_DESC"] = "Oculta automaticamente as barras ao entrar em combate para reduzir a desordem na interface."
Locales["HIDE_AT_MAX_LEVEL"] = "Ocultar Barra de XP no Nível Máximo"
Locales["HIDE_AT_MAX_LEVEL_DESC"] = "Oculta automaticamente a barra de experiência quando seu personagem atinge o nível máximo."
Locales["DATA_DISPLAY"] = "Exibição de Dados"
Locales["SHOW_PERCENTAGE"] = "Mostrar porcentagem"
Locales["SHOW_PERCENTAGE_DESC"] = "Exibe a porcentagem de progresso nas barras."
Locales["SHOW_ABSOLUTE_VALUES"] = "Mostrar valores absolutos"
Locales["SHOW_ABSOLUTE_VALUES_DESC"] = "Exibe os valores absolutos atuais e máximos (ex: 1200 / 5000)."
Locales["SHOW_SPARK"] = "Mostrar brilho"
Locales["SHOW_SPARK_DESC"] = "Mostra um brilho intenso na borda frontal das barras de progresso para melhor visibilidade."

-------------------------------------------------------------------------------
-- COLORS TAB
-------------------------------------------------------------------------------
Locales["USE_CLASS_COLOR"] = "Usar cor da classe"
Locales["USE_CLASS_COLOR_DESC"] = "Colore a barra de experiência usando a cor da classe do seu personagem."
Locales["CUSTOM_XP_COLOR"] = "Cor personalizada de XP"
Locales["SHOW_RESTED_BAR"] = "Mostrar barra de descanso"
Locales["SHOW_RESTED_BAR_DESC"] = "Exibe uma barra secundária com a experiência de descanso acumulada atualmente."
Locales["RESTED_COLOR"] = "Cor de descanso"
Locales["USE_REACTION_COLORS"] = "Usar cores conforme reação"
Locales["USE_REACTION_COLORS_DESC"] = "Colore automaticamente a barra de reputação com base na sua reação (Odiado, Neutro, Exaltado, etc.)."
...
Locales["SPLIT_LINES_DESC"] = "Quando houver múltiplas recompensas de Paragon pendentes, exibe cada facção em uma linha separada em vez de combiná-las."
...
Locales["ENABLE_ADVANCED_GRID_DESC"] = "Ative o sistema de grade avançado para posicionar as barras manualmente em linhas e colunas. Isso substitui a lógica de layout padrão."
...
Locales["USE_COMPACT_FORMAT_DESC"] = "Formata números grandes em um estilo mais curto e legível (ex: 1.2k em vez de 1200)."
Locales["EVENTS_VISIBILITY"] = "Visibilidade"
Locales["ENABLE_CAROUSEL"] = "Ativar Carrrossel de Eventos"
Locales["ENABLE_CAROUSEL_DESC"] = "Exibe um banner rotativo com os ganhos recentes de experiência e reputação."
Locales["LATERAL_LEGEND"] = "Ativar Legenda Lateral"
Locales["LATERAL_LEGEND_DESC"] = "Exibe uma legenda permanente com o status atual de todas as barras ativas."
