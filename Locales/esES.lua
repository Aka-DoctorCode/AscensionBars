...
Locales["ENABLE_DESC"] = "Activa o desactiva esta barra de progreso específica."
...
Locales["PER_BLOCK_OFFSET_DESC"] = "Activa para establecer desplazamientos Y independientes para los bloques superior e inferior en lugar de uno global."
Locales["PER_BLOCK_GAP"] = "Usar separación por bloque"
Locales["PER_BLOCK_GAP_DESC"] = "Activa para establecer separaciones independientes para los bloques superior e inferior."
...
Locales["USE_PER_BLOCK_HEIGHT_DESC"] = "Activa para establecer diferentes alturas de barra para los bloques superior e inferior."
Locales["USE_CUSTOM_HEIGHT"] = "Altura personalizada"
Locales["USE_CUSTOM_HEIGHT_DESC"] = "Alterna entre usar la altura global del bloque o establecer una altura única para esta barra específica."
...
Locales["USE_CUSTOM_FACTION_COLORS"] = "Usar colores de facción personalizados"
Locales["USE_CUSTOM_FACTION_COLORS_DESC"] = "Aplica colores únicos con temática oficial a facciones específicas en las barras de reputación activas."
Locales["CUSTOM_FACTION_COLORS"] = "Colores de facción personalizados"
Locales["ACTIVE_FACTION_COLORS"] = "Colores de facciones activas"
...
Locales["BARS_HIDDEN_COMBAT_HOVER"] = "Barras ocultas - Pasar el ratón para mostrar (Ocultas en combate)"
Locales["BARS_HIDDEN_HOVER"] = "Barras ocultas - Pasar el ratón para mostrar"
Locales["BARS_HIDDEN_COMBAT"] = "Barras ocultas en combate"
Locales["SHOW_ON_MOUSEOVER"] = "Mostrar al pasar el ratón"
Locales["SHOW_ON_MOUSEOVER_DESC"] = "Muestra las barras solo cuando el ratón está sobre ellas. Si se desactiva, las barras siempre serán visibles a menos que la ocultación en combate esté activa."
Locales["HIDE_IN_COMBAT"] = "Ocultar en combate"
Locales["HIDE_IN_COMBAT_DESC"] = "Oculta automáticamente las barras al entrar en combate para reducir el desorden en la interfaz."
Locales["HIDE_AT_MAX_LEVEL"] = "Ocultar barra de experiencia al nivel máximo"
Locales["HIDE_AT_MAX_LEVEL_DESC"] = "Oculta automáticamente la barra de experiencia cuando tu personaje alcanza el nivel máximo."
Locales["DATA_DISPLAY"] = "Visualización de datos"
Locales["SHOW_PERCENTAGE"] = "Mostrar porcentaje"
Locales["SHOW_PERCENTAGE_DESC"] = "Muestra el porcentaje de progreso en las barras."
Locales["SHOW_ABSOLUTE_VALUES"] = "Mostrar valores absolutos"
Locales["SHOW_ABSOLUTE_VALUES_DESC"] = "Muestra los valores absolutos actuales y máximos (ej. 1200 / 5000)."
Locales["SHOW_SPARK"] = "Mostrar destello"
Locales["SHOW_SPARK_DESC"] = "Muestra un destello brillante en el borde frontal de las barras de progreso para una mejor visibilidad."

-------------------------------------------------------------------------------
-- COLORS TAB
-------------------------------------------------------------------------------
Locales["USE_CLASS_COLOR"] = "Usar color de clase"
Locales["USE_CLASS_COLOR_DESC"] = "Colorea la barra de experiencia usando el color de la clase de tu personaje."
Locales["CUSTOM_XP_COLOR"] = "Color de experiencia personalizado"
Locales["SHOW_RESTED_BAR"] = "Mostrar barra de descanso"
Locales["SHOW_RESTED_BAR_DESC"] = "Muestra una barra secundaria con la experiencia de descanso acumulada actualmente."
Locales["RESTED_COLOR"] = "Color de descanso"
Locales["USE_REACTION_COLORS"] = "Usar colores según reacción"
Locales["USE_REACTION_COLORS_DESC"] = "Colorea automáticamente la barra de reputación según tu reacción (Odiado, Neutral, Exaltado, etc.)."
...
Locales["SPLIT_LINES_DESC"] = "Cuando hay múltiples recompensas de Paragón pendientes, muestra cada facción en una línea separada en lugar de combinarlas."
...
Locales["ENABLE_ADVANCED_GRID_DESC"] = "Activa el sistema de cuadrícula avanzada para posicionar las barras manualmente en filas y columnas. Esto anula la lógica de diseño estándar."
...
Locales["USE_COMPACT_FORMAT_DESC"] = "Formatea números grandes en un estilo más corto y legible (ej. 1.2k en lugar de 1200)."
Locales["EVENTS_VISIBILITY"] = "Visibilidad"
Locales["ENABLE_CAROUSEL"] = "Activar carrusel de eventos"
Locales["ENABLE_CAROUSEL_DESC"] = "Muestra un banner rotativo con las ganancias recientes de experiencia y reputación."
Locales["LATERAL_LEGEND"] = "Activar leyenda lateral"
Locales["LATERAL_LEGEND_DESC"] = "Muestra una leyenda permanente con el estado actual de todas las barras activas."
